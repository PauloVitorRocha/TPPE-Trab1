...
class SequenceDiagramBlock:
    ...
    def persist_messages(self, m_name, m_prob, source_lifeline, target_lifeline):
        if (bool(m_name) and bool(source_lifeline) and bool(target_lifeline) and bool(m_prob) and m_prob[0] != '-') == False:
